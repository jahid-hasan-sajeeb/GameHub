      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-gray-400 text-sm">
            Your ultimate destination for the latest games, news, and reviews.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-red-500">Games</a></li>
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mb-3">Subscribe to get the latest updates and game news.</p>
          <form className="flex">
            <input
              type="email"
            ...
            />
            <button className="bg-red-600 px-4 py-2 rounded-r-md text-white hover:bg-red-700 transition-all">
              Subscribe
            </button>
          </form>
        </div>
