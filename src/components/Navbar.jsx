...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black text-gray-300 py-4 px-6 md:px-28 shadow-md">
      ...
      {isOpen && (
        <div className="mt-4 md:hidden border-t border-zinc-800 pt-4">
          <ul className="flex flex-col gap-3 text-base font-medium">
            ...
            <li>
              <MyLink to="Game-Details" onClick={() => setIsOpen(false)}>
                Game Details
              </MyLink>
            </li>
            <li>
              <MyLink to="Game-Updates" onClick={() => setIsOpen(false)}>
                Articles
              </MyLink>
            </li>
            <li>
          ...
          <div className="mt-4 flex items-center">
            {user ? (
              ...
              <MyLink
                to="/login"
                onClick={() => setIsOpen(false)}
                className="w-fit px-4 py-2 bg-red-600 hover:bg-red-700 rounded-md font-semibold text-sm mt-2"
              >
                Login
              </MyLink>
            )}
