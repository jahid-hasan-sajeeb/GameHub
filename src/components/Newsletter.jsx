        ...
        <section className="bg-zinc-900 border-t border-gray-800 px-4 py-16 my-10">
            <div className="max-w-3xl mx-auto text-center">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white font-semibold text-sm px-6 py-2 rounded-md transition-all duration-300"
                    >
                        Subscribe
                    </button>
                </form>
                ...
                <p className="text-gray-500 text-xs mt-3">
                    By subscribing, you agree to receive emails from GameHub. 
